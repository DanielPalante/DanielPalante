...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 5.xlsx', sheet_name='Neon 5')
...
x_min[0] = 12.1 # Valor mínimo de X
x_max[0] = 15.3# Valor máximo de X

x_min[1] = 29.3 # Valor mínimo de X
x_max[1] = 30.8# Valor máximo de X

x_min[2] = 46.7 # Valor mínimo de X
x_max[2] = 48.1# Valor máximo de X
