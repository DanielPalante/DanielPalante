...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 2.xlsx', sheet_name='Neon 2')
...
x_min[0] = 13.5 # Valor mínimo de X
x_max[0] = 15.2# Valor máximo de X

x_min[1] = 30.0 # Valor mínimo de X
x_max[1] = 31.6# Valor máximo de X

x_min[2] = 47.3 # Valor mínimo de X
x_max[2] = 48.9# Valor máximo de X

x_min[3] = 67.2 # Valor mínimo de X
x_max[3] = 68.9# Valor máximo de X
