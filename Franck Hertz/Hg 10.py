...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Mercurio\Hg 10.xlsx', sheet_name='Hg 10')
...
for i in range(len(x_min)):
    ...
    x_min[i] = 4.4+i*4.9  # Valor mínimo de X
    x_max[i] = 5.4+i*4.9  # Valor máximo de X
