...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 8.xlsx', sheet_name='Neon 8')
...
x_max[0] = 15.0# Valor máximo de X

x_min[1] = 29.7 # Valor mínimo de X
x_max[1] = 31.0# Valor máximo de X

x_min[2] = 46.9 # Valor mínimo de X
x_max[2] = 48.0# Valor máximo de X
