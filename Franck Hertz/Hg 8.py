...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Mercurio\Hg 8.xlsx', sheet_name='Hg 8')
...
x_min[0] = 9.5  # Valor mínimo de X
x_max[0] = 10.1  # Valor máximo de X

x_min[1] = 14.5  # Valor mínimo de X
x_max[1] = 15.0  # Valor máximo de X

x_min[2] = 19.5  # Valor mínimo de X
x_max[2] = 20.3  # Valor máximo de X
