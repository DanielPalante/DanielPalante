...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 10.xlsx', sheet_name='Neon 10')
...
x_min[1] = 29.5 # Valor mínimo de X
x_max[1] = 30.6# Valor máximo de X
