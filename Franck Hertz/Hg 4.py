...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Mercurio\Hg 4.xlsx', sheet_name='Hg 4')
...
for i in range(len(x_min)):
    ...
    x_min[i] = 4.3+i*4.9  # Valor mínimo de X
    x_max[i] = 5.3+i*4.7  # Valor máximo de X
