...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 1.xlsx', sheet_name='Neon 1')
...
x_min[0] = 32.0 # Valor mínimo de X
x_max[0] = 34.2# Valor máximo de X

x_min[1] = 47.6 # Valor mínimo de X
x_max[1] = 49.5# Valor máximo de X

x_min[2] = 65.7 # Valor mínimo de X
x_max[2] = 68.5# Valor máximo de X

x_min[3] = 87.0 # Valor mínimo de X
x_max[3] = 89.3# Valor máximo de X
