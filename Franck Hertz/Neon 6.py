...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 6.xlsx', sheet_name='Neon 6')
...
x_min[0] = 12.6 # Valor mínimo de X
x_max[0] = 15.3# Valor máximo de X

x_min[1] = 29.9 # Valor mínimo de X
x_max[1] = 31.2# Valor máximo de X

x_min[2] = 47.1 # Valor mínimo de X
x_max[2] = 48.7# Valor máximo de X

x_min[3] = 67.3 # Valor mínimo de X
x_max[3] = 68.8# Valor máximo de X
