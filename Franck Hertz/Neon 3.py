...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Neon\Neon 3.xlsx', sheet_name='Neon 3')
...
x_min[0] = 48.2 # Valor mínimo de X
x_max[0] = 50.3# Valor máximo de X

x_min[1] = 65.7 # Valor mínimo de X
x_max[1] = 68.5# Valor máximo de X

x_min[2] = 86.0 # Valor mínimo de X
x_max[2] = 88.4# Valor máximo de X
