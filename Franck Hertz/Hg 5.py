...
data = pd.read_excel(r'C:\Users\julik\Desktop\Datos franck hertz\Mercurio\Hg 5.xlsx', sheet_name='Hg 5')
...
for i in range(len(x_min)):
    ...
    x_min[i] = 4.8+i*4.6  # Valor mínimo de X
    x_max[i] = 6.2+i*4.7  # Valor máximo de X
